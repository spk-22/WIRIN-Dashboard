...
import styles from '../styles/RoofBoot.module.css'; // Ensure this path is correct

interface RoofBootComponentProps {
    title1: string;
    title2: string;
...
const RoofBootComponent: React.FC<RoofBootComponentProps> = ({
    title1,
    title2,
...
export default RoofBootComponent;
